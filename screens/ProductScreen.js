...
const ProductScreen = () => {
    ...
    const gridItems = [
        { id: 1, image: require('../assets/DATA/Container73.png') },
        { id: 2, image: require('../assets/DATA/Image72.png')},
        { id: 3, image: require('../assets/DATA/Image71.png')},
        { id: 4, image: require('../assets/DATA/Image74.png')},
        { id: 5, image: require('../assets/DATA/Image7.png')},
    ];

    const handleItemPress = (id) => {
        // Set selectedItem to 1 if item with id 4 is selected, otherwise set to the clicked id
        if (id === 4) {
            setSelectedItem(1);  // Always show image of grid item 1
        } else {
            setSelectedItem(id);  // Show the selected grid item
        }
    };
    ...
    // Get the image for the selected item or default to the first item
    const selectedImage = selectedItem ? gridItems.find(item => item.id === selectedItem)?.image : gridItems[0].image;
                ...
                <View style={styles.productContainer}>
                    <View style={styles.gridContainer}>
                        <TouchableOpacity style={styles.gridItemLarge}>
                            <Image source={selectedImage} style={styles.gridItemImageLarge} />
                        </TouchableOpacity>
